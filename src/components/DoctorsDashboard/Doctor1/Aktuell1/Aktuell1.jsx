...
const Aktuell1 = () => {
  ...
  useEffect(() => {
    ...
    if (addSuccessStatus) {
      ...
      sessionStorage.removeItem("addAktuell1");
    }

    // Update toast
    const updateSuccessStatus = sessionStorage.getItem("updateAktuell1");
    if (updateSuccessStatus) {
      toast.success("Aktuell Data Updated Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("updateAktuell1");
    }
        ...
        <div className="text-end">
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              <Link
                to={`/doctors/aktuell1/editaktuell1/${record.id}`}
                        ...
                        <div className="doctor-table-blk">
                          ...
                          <div className="doctor-search-blk">
                            ...
                            <div className="add-group">
                              <Link
                                to="/doctors/aktuell1/addaktuell1"
