...
const EditIntroduction1 = () => {
        ...
        const fetchDocumentData = async () => {
            try {
                ...
                if (documentSnapshot.exists()) {
                    ...
                    setFormData({ introduction: documentData.introduction });
                    const pointIndex = parseInt(id, 10);
                    setCurrentPoint(documentData.introduction[pointIndex]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const documentSnapshot = await getDocumentByField('Doctors', 'doctorID', doctorID);
            if (documentSnapshot.exists()) {
                const newIntroduction = [...formData.introduction];
                newIntroduction[pointIndex] = currentPoint;
                await updateDocument('Doctors', documentSnapshot.id, { introduction: newIntroduction });
                sessionStorage.setItem("updateIntroduction1", 'true');
    ...
    return (
        <div>
            ...
            <Sidebar
                id="menu-item4"
                id1="menu-items4"
                activeClassName="edit-introduction1"
            />
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item ">
                                        <Link to="/doctors/introduction1">Introduction</Link>
                                    </li>
                                    <li className="breadcrumb-item">
                                        <i className="feather-chevron-right">
                                            <FeatherIcon icon="chevron-right" />
                                            ...
                                            <div className="col-12">
                                                <div className="doctor-submit text-end">
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => navigate("/doctors/introduction1")}
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
...
export default EditIntroduction1;
