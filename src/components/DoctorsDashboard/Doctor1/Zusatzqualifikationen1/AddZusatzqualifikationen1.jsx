...
const AddZusatzqualifikationen1 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (documentSnapshot) {
        ...
        sessionStorage.setItem('addZusatzqualifikationen1', 'true');
                      ...
                      <div className="row">
                        ...
                        <div className="col-12">
                          <div className="doctor-submit text-end">
                            ...
                            <Link
                              to="/doctors/zusatzqualifikationen1"
...
export default AddZusatzqualifikationen1;
