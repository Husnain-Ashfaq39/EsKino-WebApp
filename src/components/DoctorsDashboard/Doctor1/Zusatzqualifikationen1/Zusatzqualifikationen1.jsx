...
const Zusatzqualifikationen1 = () => {
  ...
  useEffect(() => {
    ...
    if (addSuccessStatus) {
      toast.success("Zusatzqualifikationen Data add Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("addZusatzqualifikationen1");
    }

    // Update toast
    const updateSuccessStatus = sessionStorage.getItem("updateZusatzqualifikationen1");
    if (updateSuccessStatus) {
      toast.success("Zusatzqualifikationen Data Updated Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("updateZusatzqualifikationen1");
    }
        ...
        <div className="text-end">
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              <Link
                to={`/doctors/zusatzqualifikationen1/editzusatzqualifikationen1/${record.id}`}
  ...
  return (
    <>
      ...
      <Sidebar
        id="menu-item4"
        id1="menu-items4"
        activeClassName="zusatzqualifikationen1"
      />
                        ...
                        <div className="doctor-table-blk">
                          ...
                          <div className="doctor-search-blk">
                            ...
                            <div className="add-group">
                              <Link
                                to="/doctors/zusatzqualifikationen1/addzusatzqualifikationen1"
...
export default Zusatzqualifikationen1;
