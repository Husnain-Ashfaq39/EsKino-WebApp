...
const HeaderandPicture2 = () => {
  ...
  useEffect(() => {
    ...
    const updateSuccessStatus = sessionStorage.getItem("updateHeaderAndPicture2");
    if (updateSuccessStatus) {
      toast.success("Doctor Data Updated Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("updateHeaderAndPicture2");
    }
        ...
        <div className="text-end">
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              <Link
                to={`/doctors/headerandpicture2/editheaderandpicture2/${record.id}`}
...
export default HeaderandPicture2;
