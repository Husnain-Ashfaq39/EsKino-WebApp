    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (documentSnapshot.exists()) {
                ...
                sessionStorage.setItem("updateIntroduction2", 'true');
    ...
    return (
        <div>
            ...
            <Sidebar
                id="menu-item4"
                id1="menu-items4"
                activeClassName="edit-introduction2"
            />
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item ">
                                        <Link to="/doctors/introduction2">Introduction</Link>
                                    </li>
                                    <li className="breadcrumb-item">
                                        <i className="feather-chevron-right">
                                            <FeatherIcon icon="chevron-right" />
                                            ...
                                            <div className="col-12">
                                                <div className="doctor-submit text-end">
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => navigate("/doctors/introduction2")}
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
...
export default EditIntroduction2;
