...
const Introduction2 = () => {
  ...
  useEffect(() => {
    ...
    // add toast
    const addSuccessStatus = sessionStorage.getItem("addIntroduction2");
    if (addSuccessStatus) {
      toast.success("Introduction Data added Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("addIntroduction2");
    }

    // Update toast
    const updateSuccessStatus = sessionStorage.getItem("updateIntroduction2");
    if (updateSuccessStatus) {
      toast.success("Introduction Data Updated Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("updateIntroduction2");
    }
        ...
        <div className="text-end">
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              <Link
                to={`/doctors/introduction2/editintroduction2/${record.id}`}
                        ...
                        <div className="doctor-table-blk">
                          ...
                          <div className="doctor-search-blk">
                            ...
                            <div className="add-group">
                              <Link
                                to="/doctors/introduction2/addintroduction2"
