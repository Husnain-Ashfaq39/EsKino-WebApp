...
const AddZusatzqualifikationen2 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (documentSnapshot) {
        ...
        const updatedZusatzqualifikationen = [...documentData.zusatzqualifikationen, formData.point];
        await updateDocument('Doctors', documentSnapshot.id, { ...documentData, zusatzqualifikationen: updatedZusatzqualifikationen });
        sessionStorage.setItem('addZusatzqualifikationen2', 'true');
              ...
              <div className="row">
                <div className="col-sm-12">
                  <ul className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">Add Zusatzqualifikationen Point</li>
                  </ul>
                </div>
              </div>
            </div>
                      ...
                      <div className="row">
                        <div className="col-12">
                          <div className="form-heading">
                            <h4>Add Zusatzqualifikationen Point</h4>
                          </div>
                        </div>
                        {/* Point */}
                        ...
                        <div className="col-12">
                          <div className="doctor-submit text-end">
                            ...
                            <Link
                              to="/doctors/zusatzqualifikationen2"
...
export default AddZusatzqualifikationen2;
