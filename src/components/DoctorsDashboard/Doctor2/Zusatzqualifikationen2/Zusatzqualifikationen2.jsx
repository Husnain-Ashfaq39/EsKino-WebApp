...
const Zusatzqualifikationen2 = () => {
  ...
  useEffect(() => {
    ...
    // Add toast
    const addSuccessStatus = sessionStorage.getItem("addZusatzqualifikationen2");
    if (addSuccessStatus) {
      toast.success("Zusatzqualifikationen Data added Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("addZusatzqualifikationen2");
    }

    // Update toast
    const updateSuccessStatus = sessionStorage.getItem("updateZusatzqualifikationen2");
    if (updateSuccessStatus) {
      toast.success("Zusatzqualifikationen Data Updated Successfully!", { autoClose: 2000 });
      sessionStorage.removeItem("updateZusatzqualifikationen2");
    }
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (documentSnapshot) {
        ...
        data.push(...documentData.zusatzqualifikationen.map((point, index) => ({ id: index, point })));
        setDataSource(data);
      } else {
  ...
  const addDummyData = async () => {
    const dummyData = {
      ...
      zusatzqualifikationen: ["Dummy Qualification 1", "Dummy Qualification 2"],
    ...
    if (deleteItemId !== null) {
      try {
        ...
        if (updatedDocument.exists()) {
          ...
          const updatedZusatzqualifikationen = documentData.zusatzqualifikationen.filter((_, index) => index !== deleteItemId);
          await updateDocument('Doctors', updatedDocument.id, { ...documentData, zusatzqualifikationen: updatedZusatzqualifikationen });
          setDataSource(updatedZusatzqualifikationen.map((point, index) => ({ id: index, point })));
        ...
        <div className="text-end">
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              <Link
                to={`/doctors/zusatzqualifikationen2/editzusatzqualifikationen2/${record.id}`}
  ...
  return (
    <>
      ...
      <Sidebar
        id="menu-item4"
        id1="menu-items4"
        activeClassName="zusatzqualifikationen2"
      />
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item">Zusatzqualifikationen</li>
                </ul>
              </div>
            </div>
          </div>
                    ...
                    <div className="row align-items-center">
                      <div className="col">
                        <div className="doctor-table-blk">
                          <h3 className="p-2">Zusatzqualifikationen</h3>
                          <div className="doctor-search-blk">
                            <div className="top-nav-search table-search-blk"></div>
                            <div className="add-group">
                              <Link
                                to="/doctors/zusatzqualifikationen2/addzusatzqualifikationen2"
...
export default Zusatzqualifikationen2;
