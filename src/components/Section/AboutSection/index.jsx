...
export default function AboutSection({
  ...
  const styles = {
    ...
    imageContainer: {
      marginTop: isMobile ? "2rem" : "0", // Add margin on mobile devices
    },
  };
      ...
      <div className="container">
        <div className="row align-items-center flex-lg-row flex-column-reverse cs_gap_y_40">
          <div className="col-lg-7">
            <div className="cs_about_img" style={styles.imageContainer}>
          ...
          <div className="col-lg-5">
            <div className="cs_about_content">
              <div className="cs_section_heading cs_style_1">
                <h2 className="cs_section_title cs_fs_72 m-0" style={styles.title}>
                  {title}
                </h2>
