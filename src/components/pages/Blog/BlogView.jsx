...
import { blogimg1, blogimg2 } from '../../imagepath';
...
const BlogView = () => {
    ...
    const handleDelete = async (blogId) => {
        try {
            await deleteDocument('blogs', blogId); // Assuming 'blogs' is the collection name
                                            ...
                                            <div className="blog-grp-blk">
                                                <div className="blog-img-blk">
                                                    ...
                                                    <div className="content-blk-blog ms-2">
                                                        <h4>
                                                            <Link to={`/profile/${blog.authorId}`}>{blog.author}</Link>
                                                        </h4>
